...
class JournalService {
  ...
  Future<JournalEntry> createEntryForDate(DateTime date) async {
    ...
    try {
      ...
      // Generate title from the narrative or use default
      ...
      final entryId = await _journalDb.insertJournalEntry(
        JournalEntriesCompanion(
          ...
          title: Value(title),
          content: Value(richNarrative), // Full narrative as content
          summary: Value(richNarrative), // Same as summary for now
          originalAiSummary: Value(richNarrative), // Store original for edit tracking
